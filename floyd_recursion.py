...
def floyd(distance, graph_range, intermediate_node=0):
    """
    ...
    if intermediate_node < graph_range:
        ...
        for start_node,end_node in itertools.product\
        (range(graph_range), range(graph_range)):
                # The iteration will be proceeded
                # for each "start_node" and each "end_node"
        ...
        return floyd(distance, graph_range, intermediate_node + 1)
